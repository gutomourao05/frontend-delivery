...
const products = [
  {
    id: 1,
    name: 'Pizza Doce Pequena',
    href: '#',
    price: 'R$ 90.00',
    quantity: 1,
    imageSrc: './src/assets/img_pizza-fotor-2024012118438.png',
...
const Card: React.FC<Props> = ({ setOpen, isOpen }): JSX.Element => {
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                    <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                      <div className="flex items-start justify-between">
                        <Dialog.Title className="text-lg font-medium text-gray-900">Carrinho de compra</Dialog.Title>
